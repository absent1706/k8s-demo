...
class FlowerCommand(Command):
    ...
    def apply_env_options(self):
        ...
        for env_var_name in env_options:
            ...
            # FIX BEGIN
            # Somewhy, FLOWER_PORT var gets invalid value 'tcp://10.106.113.118:5555'
            #  and this fact leads to crash of the whole process,
            #  see http://i.codeit.pro/oleksandr.lytvynenko/i/14-23-04.png
            # That's why we just skip this variable
            if env_var_name == 'FLOWER_PORT':
                continue
            # FIX END
            try:
